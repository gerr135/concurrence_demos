/**
 * top level class, providing interface
 */
...
public class Family {
    ...
    int IncomeDelta = 30;
    int SpendingMean  = 20;
    int SpendingDelta = 10;
    //
    int IncomeDelayMean = 1000; // miliseconds
    int IncomeDelayDlta = 200;
    int SpendDealyMean = 800;
    int SpendDelayDlta = 300;
    //
    int waitDelay = 100;
